...
const restrauList = [
  {
    ...
    data: {
      ...
      thirdPartyVendor: '',
      adTrackingID: 'cid=5767102~p=1~eid=00000185-e766-77d4-087c-74d5002c015f',
      badges: {
        imageBased: [],
        textBased: [],
        textExtendedBadges: [],
  ...
  },
  {
    ...
    data: {
      ...
      thirdPartyAddress: false,
      thirdPartyVendor: '',
      adTrackingID: 'cid=5693866~p=13~eid=00000185-e766-77d4-087c-74d9002c0d2f',
      badges: {
        imageBased: [],
        textBased: [],
        textExtendedBadges: [],
...
const Child = ({ name, cloudinaryImageId, cuisines, lastMileTravel }) => {
  return (
    <div>
      <h1>Child</h1>
